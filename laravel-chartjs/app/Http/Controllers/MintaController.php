...
class MintaController extends Controller
{
    ...
    public function datatable(Request $request)
    {
        ...
        $search_column = array(
            ...
            "id_user_pemohon" => (isset($columns[5]['search']['value'])) ? $columns[5]['search']['value'] : "",
            "id_user_menyetujui" => (isset($columns[6]['search']['value'])) ? $columns[6]['search']['value'] : "",
            "status" => (isset($columns[7]['search']['value'])) ? $columns[7]['search']['value'] : "",
            "created_at" => (isset($columns[8]['search']['value'])) ? $columns[8]['search']['value'] : "",
            "user_create" => (isset($columns[9]['search']['value'])) ? $columns[9]['search']['value'] : "",
            "updated_at" => (isset($columns[10]['search']['value'])) ? $columns[10]['search']['value'] : "",
            "user_update" => (isset($columns[11]['search']['value'])) ? $columns[11]['search']['value'] : "",
        );
        ...
        if ($order_index == 1)
            ...
            $order_field = 'id_user_pemohon';
        else if ($order_index == 6)
            $order_field = 'id_user_menyetujui';
        ...
        $sql_total = $minta->count();
        $sql_filter = $minta->filter(
            $order_field,
            $order_ascdesc,
            $search,
            $search_column,
        ...
        foreach ($filter_data as $value) {
            ...
            $action = '';
            if (check_user_access(Session::get('user_access'), 'minta_update')) {
                $action .= "<a class='btn btn-info btn-sm' href='" . route('minta.edit', base64_encode($value->id)) . "'><i class='fa fa-fw fa-pencil'></i> Edit</a>";
            }
            ...
            $row[] = $value->no_faktur;
            $row[] = $value->id_user_pemohon;
            $row[] = $value->id_user_menyetujui;
